package com.darbin.ontu.custom.recyclerviews
...
class HorizontalCarouselRecyclerView(
    ...
    private val activeColor by lazy { ContextCompat.getColor(context, R.color.color_blue) }
    private val inactiveColor by lazy { ContextCompat.getColor(context, R.color.color_red) }
    ...
    private fun onScrollChanged() {
        post {
            (0 until childCount).forEach { position ->
                ...
                val scaleValue = getGaussianScale(childCenterX, 1f, 1f, 120.toDouble())
